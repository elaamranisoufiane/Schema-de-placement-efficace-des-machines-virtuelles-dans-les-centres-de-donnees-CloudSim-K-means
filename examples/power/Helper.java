...
import org.cloudbus.cloudsim.power.PowerVmAllocationPolicyPABFD;
...
//added
	...
	public static List<Cloudlet> createCloudletListPlanetLab(int brokerId, String inputFolderName)
	 ...
	 //new	 
		public static VmAllocationPolicy getVmAllocationPolicy(String vmAllocationPolicyName,String vmSelectionPolicyName,String parameterName,
				List<PowerHost> hostList) {
			...
			if (vmAllocationPolicyName.equals("iqr")) {
				...
				vmAllocationPolicy = new PowerVmAllocationPolicyPABFD(hostList,vmSelectionPolicy);
			} 
			//test
			 else if (vmAllocationPolicyName.equals("PABFD")) {
					vmAllocationPolicy = new PowerVmAllocationPolicyPABFD(hostList,vmSelectionPolicy);
				}
		...
		public static PowerVmSelectionPolicy getVmSelectionPolicy(String vmSelectionPolicyName) {
			PowerVmSelectionPolicy vmSelectionPolicy = null;
